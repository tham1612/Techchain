!function () {
    ...
    function n(e) {
        ...
        ("en" == e ? document.getElementById("header-lang-img").src = `${PATH_ROOT}/assets/images/flags/us.svg` : "sp" == e ? document.getElementById("header-lang-img").src = `${PATH_ROOT}/assets/images/flags/spain.svg` : "gr" == e ? document.getElementById("header-lang-img").src = `${PATH_ROOT}/assets/images/flags/germany.svg` : "it" == e ? document.getElementById("header-lang-img").src = `${PATH_ROOT}/assets/images/flags/germany.svg` : "ru" == e ? document.getElementById("header-lang-img").src = `${PATH_ROOT}/assets/images/flags/russia.svg` : "ch" == e ? document.getElementById("header-lang-img").src = `${PATH_ROOT}/assets/images/flags/china.svg` : "fr" == e ? document.getElementById("header-lang-img").src = "assets/images/flags/french.svg" : "ar" == e
            && (document.getElementById("header-lang-img").src = `${PATH_ROOT}/assets/images/flags/ae.svg`), localStorage.setItem("language", e),
        null == (a = localStorage.getItem("language")) && n(t), (e = new XMLHttpRequest).open("GET", `${PATH_ROOT}/assets/lang/` + a + ".json"),
    ...
    function s() {
        ...
        (e = document.querySelectorAll(".navbar-nav .collapse"), Array.from(e).forEach(function (t) {
    ...
    function i() {
        var n, e = document.documentElement.getAttribute("data-layout"), t = sessionStorage.getItem("defaultAttribute"),
            t = JSON.parse(t);
        !t || "twocolumn" != e && "twocolumn" != t["data-layout"] || (document.querySelector(".navbar-menu") && (document.querySelector(".navbar-menu").innerHTML = d), (n = document.createElement("ul")).innerHTML = '<a href="#" class="logo"><img src=`${PATH_ROOT}/assets/images/logo-sm.png` alt="" height="22"></a>', Array.from(document.getElementById("navbar-nav").querySelectorAll(".menu-link")).forEach(function (e) {
    ...
    function H() {
        Array.from(document.querySelectorAll("#notificationItemsTabContent .tab-pane")).forEach(function (e) {
            0 < e.querySelectorAll(".notification-item").length ? e.querySelector(".view-all") && (e.querySelector(".view-all").style.display = "block") : (e.querySelector(".view-all") && (e.querySelector(".view-all").style.display = "none"), e.querySelector(".empty-notification-elem") || (e.innerHTML += '<div class="empty-notification-elem">\t\t\t\t\t\t\t<div class="w-25 w-sm-50 pt-3 mx-auto">\t\t\t\t\t\t\t\t' +
